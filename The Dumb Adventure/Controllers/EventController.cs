	...
	public class EventController : ControllerBase
	{
		...
		private static List<GameEvent> events = new List<GameEvent>
		{
			...
			new GameEvent
			{
				...
				Options = new List<EventOption> {
					new EventOption { Text = "Sten", Points = rnd.Next(-10, 10), Result = "Gåsen angriber dig!"},
					new EventOption { Text = "Saks", Points = rnd.Next(-10, 10), Result = "Du undslap Gåsen!"},
					new EventOption { Text = "Papir", Points = rnd.Next(-10, 10), Result = "Gåsen respekterer dig!"}
				}
			}
